...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `42.9µs` | `69.3µs` |
| [Day 2](./src/bin/02.rs) | `125.5µs` | `251.2µs` |
| [Day 3](./src/bin/03.rs) | `204.8µs` | `335.1µs` |
| [Day 4](./src/bin/04.rs) | `389.5µs` | `76.1µs` |
| [Day 5](./src/bin/05.rs) | `167.3µs` | `297.5µs` |
